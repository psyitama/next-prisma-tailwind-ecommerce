...
-- CreateTable
CREATE TABLE "_CrossSellRelation" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_CrossSellRelation_AB_unique" ON "_CrossSellRelation"("A", "B");

-- CreateIndex
CREATE INDEX "_CrossSellRelation_B_index" ON "_CrossSellRelation"("B");
...
-- AddForeignKey
ALTER TABLE "_CrossSellRelation" ADD CONSTRAINT "_CrossSellRelation_A_fkey" FOREIGN KEY ("A") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CrossSellRelation" ADD CONSTRAINT "_CrossSellRelation_B_fkey" FOREIGN KEY ("B") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;
